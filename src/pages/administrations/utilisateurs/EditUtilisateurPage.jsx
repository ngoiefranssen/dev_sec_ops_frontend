...
export default function EditUtilisateurPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetchApi(`/utilisateurs/${params.ID_utilisateur}`, {
                method: 'PUT',
                body: formData,
            });
    ...
    useEffect(() => {
        document.title = utilisateurs_routes_items.edit_utilisateur.name;

        setBreadCrumbAction([utilisateurs_routes_items.utilisateurs, utilisateurs_routes_items.edit_utilisateur])
