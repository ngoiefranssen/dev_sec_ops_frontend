...
export default function RoleListPage() {
  ...
  const deleteItems = async (itemsIds) => {
    try {
      ...
      form.append("ROLE_IDS", JSON.stringify(Array.isArray(itemsIds) ? itemsIds : [itemsIds.ROLE_ID]));
                  ...
                  let items = [
                    {
                      ...
                      items: [
                        ...
                        },
                        {
                          ...
                          template: item => (
                            <div className='p-menuitem-content px-3'>
                              <a onClick={e => handleDeletePress(e, inViewMenuItem || selectedItems.map(e => e.ROLE_ID))} className="flex align-items-center p-2" style={{ textDecoration: "none", color: '#3d3d3d' }}>
